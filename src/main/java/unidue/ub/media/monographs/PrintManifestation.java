 ...
 * @version 1
 */
public class PrintManifestation  implements Cloneable,Comparable<PrintManifestation> {
    ...
    public PrintManifestation() {
    }

    public PrintManifestation(String titleID) {
    ...
    public boolean equals(Object other) {
        return shelfmark.equals(((PrintManifestation) other).shelfmark);
    }
    ...
    public PrintManifestation clone() {
        PrintManifestation clone = new PrintManifestation(shelfmark);
        for (Item item : items)
            clone.addItem(item);
        return clone;
    }
    ...
    public int compareTo(PrintManifestation other) {
